...
// Shared mini-knob cell: the top bar and the slice lane use the same
// footprint so global and per-slice knobs read as the same control.
constexpr int kKnobW = 48;
constexpr int kKnobH = 37;
